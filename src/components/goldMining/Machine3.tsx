      ...
      <div className="flex items-center justify-center">
        <div className="w-5/6 h-[360px] text-left flex flex-col font-sans relative -top-12">
          ...
          <div className="flex justify-center">
            <button className=" bg-green-500 text-white rounded-full px-4 py-2 w-32  hover:bg-green-700 focus:outline-none focus:shadow-outline-green active:bg-green-800" onClick={() => setIsFlipped3((prev) => !prev)}>
              BUY
            </button>
          </div>
        </div>
