...
export const SuccessAlert: React.FC<AlertProps> = ({ message }) => (
  <div className="fixed top-0 z-50 flex items-start justify-end w-full h-full">
...
export const ErrorAlert: React.FC<AlertProps> = ({ message }) => (
  <div className="fixed inset-0 z-50 flex items-start justify-end w-full h-full">
...
export const WarningAlert: React.FC<AlertProps> = ({ message }) => (
  <div className="fixed inset-0 z-50 flex items-start justify-end w-full h-full">
    <div className="bg-orange-200 px-6 py-4 my-4 rounded-md text-lg flex items-center  max-w-lg">
...
export const InfoAlert: React.FC<AlertProps> = ({ message }) => (
  <div className="fixed inset-0 z-50 flex items-start justify-end w-full h-full">
    <div className="bg-blue-200 px-6 py-4 mx-2 my-4 rounded-md text-lg flex items-center  max-w-lg">
...
//     return (
//         <div>
//             <SuccessAlert message="Your account has been saved." />
//             <ErrorAlert message="Your email address is invalid." />
//             <WarningAlert message="You are currently on the Free plan." />
//             <InfoAlert message="We've updated a few things." />
//         </div>
//     );
// };
