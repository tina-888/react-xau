...
const Modal = () => {
  ...
  return (
    <>
      {/* Button */}
      <button className="uppercase py-2 px-4 rounded-lg bg-transparent border-2 border-custom-gold text-custom-gold dark:text-white hover:bg-custom-gold hover:text-white text-max-md" onClick={() => setShowModal(true)}>
        Login
      </button>
      ...
      {showModal && (
        <div className="fixed inset-0 z-10 flex pt-16 overflow-auto bg-black bg-opacity-50">
          <div className="relative mx-auto w-full max-w-max-md px-6 shadow-xl ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10">
